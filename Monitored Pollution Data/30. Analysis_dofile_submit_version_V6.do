...
d_discexp_neg rank_d_discexp_neg size bm roa lev firm_age rank au_years loss sale salesgrowth lit InstOwn_Perc   stockreturn sale_sd oa_scale hhi_sale cover pollutant_value arithmeticmean aqi

*========= t-test table ========================
summarize arithmeticmean if !mi(arithmeticmean), d
local arithmeticmean_median = r(p50) 
gen polluted = (arithmeticmean > `arithmeticmean_median') if !mi(arithmeticmean)

eststo allsample: estpost summarize $summ_vars if !mi(arithmeticmean)
...
*==================== Regression (Signed) =============================
	eststo clear
eststo regression1: reghdfe dacck arithmeticmean $control_variables_aem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
...
eststo regression2: reghdfe dac arithmeticmean $control_variables_aem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize dac
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression3: reghdfe rank_dac arithmeticmean $control_variables_aem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize rank_dac
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression4: reghdfe rem arithmeticmean $control_variables_rem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize rem
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression5: reghdfe rank_rem arithmeticmean $control_variables_rem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize rank_rem
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo sales1: reghdfe d_cfo_neg arithmeticmean $control_variables_rem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize d_cfo_neg
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo sales2: reghdfe rank_d_cfo_neg arithmeticmean $control_variables_rem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear) 
estadd scalar ar2 = e(r2_a)
...
eststo overprod1: reghdfe d_prod arithmeticmean $control_variables_rem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize d_prod
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo overprod2: reghdfe rank_d_prod arithmeticmean $control_variables_rem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
...
eststo expenditure1: reghdfe d_discexp_neg arithmeticmean $control_variables_rem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
...
eststo expenditure2: reghdfe rank_d_discexp_neg arithmeticmean $control_variables_rem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
...
*================================== External Monitoring? Analyst ================================
	eststo clear
eststo regression1: reghdfe dacck arithmeticmean cover c.arithmeticmean#c.cover $control_variables_aem_t78, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear) //c.?
estadd scalar ar2 = e(r2_a)
summarize dacck
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression2: reghdfe dac arithmeticmean cover c.arithmeticmean#c.cover $control_variables_aem_t78, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear) //c.?
estadd scalar ar2 = e(r2_a)
summarize dac
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression3: reghdfe rank_dac arithmeticmean cover c.arithmeticmean#c.cover $control_variables_aem_t78, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear) //c.?
estadd scalar ar2 = e(r2_a)
summarize dac
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression4: reghdfe rem arithmeticmean cover c.arithmeticmean#c.cover $control_variables_rem_t78, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize rem
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression5: reghdfe rank_rem arithmeticmean cover c.arithmeticmean#c.cover $control_variables_rem_t78, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize rem
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
mtitles("\makecell{AEM \\ (performance-adj.)}" "\makecell{AEM \\ (modified Jones)}" "\makecell{AEM \\ Rank}" "REM" "\makecell{REM \\ Rank}") collabels(none) booktabs label scalar(ymean) order(arithmeticmean cover c.arithmeticmean#c.cover) starlevels(* 0.2 ** 0.1 *** 0.02) ///
...
label var CGOV_con_num "CG Concerns"
	eststo clear
eststo regression1: reghdfe dacck arithmeticmean CGOV_str_num c.arithmeticmean#c.CGOV_str_num $control_variables_aem_t78, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear) //c.?
estadd scalar ar2 = e(r2_a)
summarize dacck
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression2: reghdfe dacck arithmeticmean CGOV_con_num c.arithmeticmean#c.CGOV_con_num $control_variables_aem_t78, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear) //c.?
estadd scalar ar2 = e(r2_a)
summarize dacck
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression3: reghdfe dac arithmeticmean CGOV_str_num c.arithmeticmean#c.CGOV_str_num $control_variables_aem_t78, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear) //c.?
estadd scalar ar2 = e(r2_a)
summarize dac
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression4: reghdfe dac arithmeticmean CGOV_con_num c.arithmeticmean#c.CGOV_con_num $control_variables_aem_t78, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear) //c.?
estadd scalar ar2 = e(r2_a)
summarize dac
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression5: reghdfe rem arithmeticmean CGOV_str_num c.arithmeticmean#c.CGOV_str_num $control_variables_rem_t78, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize rem
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression6: reghdfe rem arithmeticmean CGOV_con_num c.arithmeticmean#c.CGOV_con_num $control_variables_rem_t78, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize rem
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
label var Boardindependence "Board Ind."
	eststo clear
eststo regression1: reghdfe dacck arithmeticmean Boardindependence c.arithmeticmean#c.Boardindependence $control_variables_aem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear) 
estadd scalar ar2 = e(r2_a)
summarize dacck
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression2: reghdfe dacck arithmeticmean boarddiversity c.arithmeticmean#c.boarddiversity $control_variables_aem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize dacck
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression3: reghdfe dac arithmeticmean Boardindependence c.arithmeticmean#c.Boardindependence $control_variables_aem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear) 
estadd scalar ar2 = e(r2_a)
summarize dac
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression4: reghdfe dac arithmeticmean boarddiversity c.arithmeticmean#c.boarddiversity $control_variables_aem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize dac
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression5: reghdfe rem arithmeticmean Boardindependence c.arithmeticmean#c.Boardindependence $control_variables_rem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize rem
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression6: reghdfe rem arithmeticmean boarddiversity c.arithmeticmean#c.boarddiversity $control_variables_rem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize rem
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
nomtitles nonumbers collabels(none) booktabs label order(arithmeticmean Boardindependence c.arithmeticmean#c.Boardindependence boarddiversity c.arithmeticmean#c.boarddiversity) starlevels(* 0.2 ** 0.1 *** 0.02) ///
stats(firmcont yearfe indfe N ar2, fmt(0 0 0 0 2 2) labels("Baseline Controls" "Year FE" "Industry FE" "N" "Adjusted R-sq")) ///
...
eststo regression1: reghdfe dacck arithmeticmean gparachute c.arithmeticmean#c.gparachute $control_variables_aem_t78, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear) //c.?
estadd scalar ar2 = e(r2_a)
summarize dacck
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression2: reghdfe dacck arithmeticmean ppill c.arithmeticmean#c.ppill $control_variables_aem_t78, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear) //c.?
estadd scalar ar2 = e(r2_a)
summarize dacck
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression3: reghdfe dac arithmeticmean gparachute c.arithmeticmean#c.gparachute $control_variables_aem_t78, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear) //c.?
estadd scalar ar2 = e(r2_a)
summarize dac
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression4: reghdfe dac arithmeticmean ppill c.arithmeticmean#c.ppill $control_variables_aem_t78, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear) //c.?
estadd scalar ar2 = e(r2_a)
summarize dac
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression5: reghdfe rem arithmeticmean gparachute c.arithmeticmean#c.gparachute $control_variables_rem_t78, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize rem
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression6: reghdfe rem arithmeticmean ppill c.arithmeticmean#c.ppill $control_variables_rem_t78, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize rem
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
mgroups("Accrual Earnings Management" "Real Earnings Management", pattern(1 0 0 0 1 0) prefix(\multicolumn{@span}{c}{) suffix(}) span erepeat(\cmidrule(lr){@span})) drop($control_variables_rem_t78 $control_variables_aem_t78) mtitles("\makecell{AEM \\ (performance-adj.)}" "\makecell{AEM \\ (performance-adj.)}" "\makecell{AEM \\ (modified Jones)}" "\makecell{AEM \\ (modified Jones)}" "REM" "REM")  collabels(none) booktabs label stats(firmcont yearfe indfe N ar2, fmt(0 0 0 0 2 2) labels("Baseline Controls" "Year FE" "Industry FE" "N" "Adjusted R-sq")) order(arithmeticmean gparachute c.arithmeticmean#c.gparachute ppill c.arithmeticmean#c.ppill) prehead("\begin{table}\begin{center}\scalebox{0.6}{\begin{tabular}{lcccccc}\toprule") posthead("\midrule&\multicolumn{6}{c}{\textbf{Panel C: CG = Golden Parachute or Poison Pill}}\\") /*starlevels(* 0.2 ** 0.1 *** 0.02)*/
...
label var dual_max "CEO-Chairman Duality"
	eststo clear
eststo regression1: reghdfe dacck  arithmeticmean CEOduality c.arithmeticmean#c.CEOduality $control_variables_aem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear) //c.?
estadd scalar ar2 = e(r2_a)
summarize dacck
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression2: reghdfe dacck arithmeticmean dual_max c.arithmeticmean#c.dual_max $control_variables_aem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear) //c.?
estadd scalar ar2 = e(r2_a)
summarize dacck
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression3: reghdfe dac arithmeticmean CEOduality c.arithmeticmean#c.CEOduality $control_variables_aem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear) //c.?
estadd scalar ar2 = e(r2_a)
summarize dac
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression4: reghdfe dac arithmeticmean dual_max c.arithmeticmean#c.dual_max $control_variables_aem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear) //c.?
estadd scalar ar2 = e(r2_a)
summarize dac
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression5: reghdfe rem arithmeticmean CEOduality c.arithmeticmean#c.CEOduality $control_variables_rem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize rem
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression6: reghdfe rem arithmeticmean dual_max c.arithmeticmean#c.dual_max $control_variables_rem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize rem
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
drop($control_variables_rem $control_variables_aem) ///
mtitles("Duality 1" "Duality 2" "Duality 1" "Duality 2" "Duality 1" "Duality 2") nonumbers collabels(none) booktabs label order(arithmeticmean CEOduality c.arithmeticmean#c.CEOduality dual_max c.arithmeticmean#c.dual_max) ///
...
esttab regression1 regression2 regression3 regression4 regression5 using "$output\table9_panelAB_PM25.tex", replace fragment keep(arithmeticmean) ///
mgroups("Accrual Earnings Management" "Real Earnings Management", pattern(1 0 0 1 0) prefix(\multicolumn{@span}{c}{) suffix(}) span erepeat(\cmidrule(lr){@span})) ///
...
esttab regression1 regression2 regression3 regression4 regression5 using "$output\table9_panelAB_PM25.tex", append fragment keep(arithmeticmean) ///
...
esttab regression1 regression2 regression3 regression4 regression5 using "$output\table9_panelCD_PM25.tex", replace fragment keep(arithmeticmean) /// 
mgroups("Accrual Earnings Management" "Real Earnings Management", pattern(1 0 0 1 0) prefix(\multicolumn{@span}{c}{) suffix(}) span erepeat(\cmidrule(lr){@span})) ///
mtitles("\makecell{AEM \\ (performance-adj.)}" "\makecell{AEM \\ (modified Jones)}" "\makecell{AEM \\ Rank}" "REM" "\makecell{REM \\ Rank}") collabels(none) booktabs label ///
stats(firmcon yearfe indfe N ar2, fmt(0 0 0 0 2 2) labels("Baseline Controls" "Year FE" "Industry FE" "N" "Adjusted R-sq")) ///
...
esttab regression1 regression2 regression3 regression4 regression5 using "$output\table9_panelCD_PM25.tex", append fragment keep(arithmeticmean) ///
nomtitles nonumbers collabels(none) booktabs label ///
...
label var fog "Fog"
	eststo clear
eststo regression1: reghdfe log_tfp arithmeticmean $control_variables, absorb(fyear) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize dacck
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression2: reghdfe log_tfp arithmeticmean $control_variables, absorb(ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize dacck
estadd scalar ymean = r(mean)
...
eststo regression3: reghdfe log_tfp arithmeticmean $control_variables, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize dacck
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
label var coastal "Coastal"
	...
	eststo clear
eststo regression1: reghdfe rem arithmeticmean $control_variables_rem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize rem
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression2: reghdfe rem arithmeticmean $control_variables_rem coastal, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize rem
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression3: reghdfe rem arithmeticmean $control_variables_rem coastal c.arithmeticmean#c.coastal, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize rem
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression4: reghdfe rank_rem arithmeticmean $control_variables_rem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize rem
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression5: reghdfe rank_rem arithmeticmean $control_variables_rem coastal, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize rem
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression6: reghdfe rank_rem arithmeticmean $control_variables_rem coastal c.arithmeticmean#c.coastal, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize rem
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
reghdfe visib arithmeticmean $control_variables_aem, absorb(i.fyear i.ff_48) vce(cluster i.lpermno#i.fyear)
predict visib_PM2_5_aem, xb
label var visib_PM2_5_aem "Fitted visibility (AEM)"

reghdfe visib arithmeticmean $control_variables_rem, absorb(i.fyear i.ff_48) vce(cluster i.lpermno#i.fyear)
predict visib_PM2_5_rem, xb
label var visib_PM2_5_rem "Fitted visibility (REM)"

reghdfe visib arithmeticmean $first_stage, absorb(i.fyear i.ff_48) vce(cluster i.lpermno#i.fyear)
...
merge m:1 state city fyear using "$maindir\US_PM25_weightedannualmean.dta"
keep if _m == 1 | _m == 3 //3583 observations, or 762 state-city-fyears
label var arithmeticmean "PM 2.5"
...
label var hhi_sale "HHI"
	...
	capture drop arithmeticmean_median
	capture drop arithmeticmean_binary
	capture drop arithmeticmean_binary_neg
egen arithmeticmean_median = median(arithmeticmean)
gen arithmeticmean_binary = (arithmeticmean > arithmeticmean_median) if !mi(arithmeticmean)
gen arithmeticmean_binary_neg = -arithmeticmean_binary
...
psmatch2 arithmeticmean_binary $control_variables_psm, outcome(rem) ai(3) ///
...
eststo treatall: estpost sum $control_variables_psm if arithmeticmean > arithmeticmean_median
eststo controlall: estpost sum $control_variables_psm if arithmeticmean <= arithmeticmean_median
eststo diffall: estpost ttest $control_variables_psm, by(arithmeticmean_binary_neg) 
eststo treatpsm: estpost sum $control_variables_psm if arithmeticmean > arithmeticmean_median & _support == 1
eststo controlpsm: estpost sum $control_variables_psm if arithmeticmean <= arithmeticmean_median  & _support == 1
eststo diffpsm: estpost ttest $control_variables_psm if _support == 1, by(arithmeticmean_binary_neg) 

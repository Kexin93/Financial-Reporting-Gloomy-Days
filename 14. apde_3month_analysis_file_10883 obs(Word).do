...
* .tex
estout obs Mean std p25 p50 p75 using "$output\summ_stats_weather_10883.rtf", ///
...
title("Summary Statistics of Weather-related Characteristics (Three-month Exposure)")  ///
...
esttab regression1 regression2 regression3 regression4 regression5 using "$output\table4_10883.rtf", replace ///
...
* .tex
estout obs Mean std p25 p50 p75 using "$output\summ_stats_firm_11283.rtf", ///
label cells("count(pattern(1 0 0 0 0 0)) mean(pattern(0 1 0 0 0 0) fmt(2)) sd(pattern(0 0 1 0 0 0) fmt(2)) p25(pattern(0 0 0 1 0 0) fmt(2)) p50(pattern(0 0 0 0 1 0) fmt(2)) p75(pattern(0 0 0 0 0 1) fmt(2))")  ///
nonumbers replace collabels(none) mlabels("N" "Mean" "Std. Dev." "Bottom 25%" "Median" "Top 25%") ///
title("Summary Statistics of Firm Characteristics (One-year Exposure)")  ///
...
* .tex
estout obs Mean std p25 p50 p75 using "$output\summ_stats_weather_11283.rtf",  ///
label cells("count(pattern(1 0 0 0 0 0)) mean(pattern(0 1 0 0 0 0) fmt(2)) sd(pattern(0 0 1 0 0 0) fmt(2)) p25(pattern(0 0 0 1 0 0) fmt(2)) p50(pattern(0 0 0 0 1 0) fmt(2)) p75(pattern(0 0 0 0 0 1) fmt(2))") ///
nonumbers replace collabels(none) mlabels("N" "Mean" "Std. Dev." "Bottom 25\%" "Median" "Top 25\%") ///
title("Summary Statistics of Weather-related Characteristics (One-year Exposure)")  ///
...
esttab regression1 regression2 regression3 regression4 regression5 using "$output\table4_11283.rtf", replace ///
mgroups("Accrual Earnings Management" "Real Earnings Management", pattern(1 0 0 1 0)) ///
mtitles("AEM (performance-adj.)" "AEM (modified Jone's')" "AEM Rank" "REM" "REM Rank") collabels(none) label scalar(ymean) ///
stats(yearfe indfe N ymean ar2, fmt(0 0 0 2 2) labels("Year FE" "Industry FE" "N" "Dep mean" "Adjusted R-sq")) ///
title("The Effect of Visibility on Earnings Management (One-year Exposure)")  ///

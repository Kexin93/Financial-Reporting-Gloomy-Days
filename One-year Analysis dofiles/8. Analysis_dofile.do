...
stats(yearfe indfe N ymean ar2, fmt(0 0 0 2 2) labels("Year FE" "Industry FE" "N" "Dep mean" "Adjusted R-sq")) ///
prehead("\begin{table}\begin{center}\caption{The Effect of Visibility on Earnings Management (One-year Exposure)}\label{tab: tablea4}\tabcolsep=0.1cm\begin{tabular}{lcccc}\toprule")  ///

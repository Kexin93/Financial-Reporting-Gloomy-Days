...
/*
	...
	*/
		...
		* For each firm, collapse weather data by firm
		cd "$maindir\Analysis_102148 observations\TempFirmStation"
		clear 
		fs "*.dta"
		append using `r(files)',force
		sort Num
		save "$maindir\Analysis_102148 observations\Firm_Multiple_Stations", replace //22590
		...
		/*keep 48332 data set*/
		preserve
		unique lpermno fyear station
		keep lpermno fyear station
		save "$maindir\Analysis_102148 observations\firm_year_stations_48332.dta", replace
		restore

...
*========= t-test table ========================
summarize visib_PM2_5 if !mi(visib_PM2_5), d
local visib_PM2_5_median = r(p50) 
	capture drop polluted
gen polluted = (visib_PM2_5 < `visib_PM2_5_median') if !mi(visib_PM2_5)

eststo allsample: estpost summarize $summ_vars if !mi(visib_PM2_5)
...
*==================== Regression (Signed) =============================
	eststo clear
eststo regression1: reghdfe dacck visib_PM2_5 $control_variables_aem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
...
eststo regression2: reghdfe dac visib_PM2_5 $control_variables_aem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize dac
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression3: reghdfe rank_dac visib_PM2_5 $control_variables_aem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize rank_dac
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression4: reghdfe rem visib_PM2_5 $control_variables_rem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize rem
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression5: reghdfe rank_rem visib_PM2_5 $control_variables_rem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize rank_rem
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo sales1: reghdfe d_cfo_neg visib_PM2_5 $control_variables_rem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize d_cfo_neg
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo sales2: reghdfe rank_d_cfo_neg visib_PM2_5 $control_variables_rem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear) 
estadd scalar ar2 = e(r2_a)
...
eststo overprod1: reghdfe d_prod visib_PM2_5 $control_variables_rem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize d_prod
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo overprod2: reghdfe rank_d_prod visib_PM2_5 $control_variables_rem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
...
eststo expenditure1: reghdfe d_discexp_neg visib_PM2_5 $control_variables_rem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
...
eststo expenditure2: reghdfe rank_d_discexp_neg visib_PM2_5 $control_variables_rem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
...
posthead("\midrule") postfoot("\bottomrule\end{tabular}}\end{center}\footnotesize{Notes: This table presents the regression results to test the fitted visiblity (by PM 2.5) on REM using three individual REM measures and their ranks. See Appendix A for detailed variable definitions. Numbers in parentheses represent t-statistics calculated based on standard errors clustered at the industry-year level. ***, **, and * indicate statistical significance at the 1\%, 5\%, and 10\% levels, respectively.}\end{table}") 
...
*================================== External Monitoring? Analyst ================================
	eststo clear
eststo regression1: reghdfe dacck visib_PM2_5 cover c.visib_PM2_5#c.cover $control_variables_aem_t78, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear) //c.?
estadd scalar ar2 = e(r2_a)
summarize dacck
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression2: reghdfe dac visib_PM2_5 cover c.visib_PM2_5#c.cover $control_variables_aem_t78, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear) //c.?
estadd scalar ar2 = e(r2_a)
summarize dac
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression3: reghdfe rank_dac visib_PM2_5 cover c.visib_PM2_5#c.cover $control_variables_aem_t78, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear) //c.?
estadd scalar ar2 = e(r2_a)
summarize dac
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression4: reghdfe rem visib_PM2_5 cover c.visib_PM2_5#c.cover $control_variables_rem_t78, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize rem
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression5: reghdfe rank_rem visib_PM2_5 cover c.visib_PM2_5#c.cover $control_variables_rem_t78, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize rem
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
mtitles("\makecell{AEM \\ (performance-adj.)}" "\makecell{AEM \\ (modified Jones)}" "\makecell{AEM \\ Rank}" "REM" "\makecell{REM \\ Rank}") collabels(none) booktabs label scalar(ymean) order(visib_PM2_5 cover c.visib_PM2_5#c.cover) starlevels(* 0.2 ** 0.1 *** 0.02) ///
...
posthead("\midrule") postfoot("\bottomrule\end{tabular}}\end{center}\footnotesize{Notes: This table presents the regression results to test the moderating effect of analyst following on the relation between fitted visibilty (by PM 2.5) and AEM/REM. See Appendix A for detailed variable definitions. Numbers in parentheses represent t-statistics calculated based on standard errors clustered at the industry-year level. ***, **, and * indicate statistical significance at the 1\%, 5\%, and 10\% levels, respectively.}\end{table}") 
...
label var CGOV_con_num "CG Concerns"
	eststo clear
eststo regression1: reghdfe dacck visib_PM2_5 CGOV_str_num c.visib_PM2_5#c.CGOV_str_num $control_variables_aem_t78, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear) //c.?
estadd scalar ar2 = e(r2_a)
summarize dacck
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression2: reghdfe dacck visib_PM2_5 CGOV_con_num c.visib_PM2_5#c.CGOV_con_num $control_variables_aem_t78, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear) //c.?
estadd scalar ar2 = e(r2_a)
summarize dacck
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression3: reghdfe dac visib_PM2_5 CGOV_str_num c.visib_PM2_5#c.CGOV_str_num $control_variables_aem_t78, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear) //c.?
estadd scalar ar2 = e(r2_a)
summarize dac
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression4: reghdfe dac visib_PM2_5 CGOV_con_num c.visib_PM2_5#c.CGOV_con_num $control_variables_aem_t78, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear) //c.?
estadd scalar ar2 = e(r2_a)
summarize dac
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression5: reghdfe rem visib_PM2_5 CGOV_str_num c.visib_PM2_5#c.CGOV_str_num $control_variables_rem_t78, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize rem
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression6: reghdfe rem visib_PM2_5 CGOV_con_num c.visib_PM2_5#c.CGOV_con_num $control_variables_rem_t78, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize rem
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
label var Boardindependence "Board Ind."
	eststo clear
eststo regression1: reghdfe dacck visib_PM2_5 Boardindependence c.visib_PM2_5#c.Boardindependence $control_variables_aem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear) 
estadd scalar ar2 = e(r2_a)
summarize dacck
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression2: reghdfe dacck visib_PM2_5 boarddiversity c.visib_PM2_5#c.boarddiversity $control_variables_aem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize dacck
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression3: reghdfe dac visib_PM2_5 Boardindependence c.visib_PM2_5#c.Boardindependence $control_variables_aem_t78, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear) 
estadd scalar ar2 = e(r2_a)
summarize dac
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression4: reghdfe dac visib_PM2_5 boarddiversity c.visib_PM2_5#c.boarddiversity $control_variables_aem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize dac
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression5: reghdfe rem visib_PM2_5 Boardindependence c.visib_PM2_5#c.Boardindependence $control_variables_rem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize rem
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression6: reghdfe rem visib_PM2_5 boarddiversity c.visib_PM2_5#c.boarddiversity $control_variables_rem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize rem
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
nomtitles nonumbers collabels(none) booktabs label order(visib_PM2_5 Boardindependence c.visib_PM2_5#c.Boardindependence boarddiversity c.visib_PM2_5#c.boarddiversity) starlevels(* 0.2 ** 0.1 *** 0.02) ///
stats(firmcont yearfe indfe N ar2, fmt(0 0 0 0 2 2) labels("Baseline Controls" "Year FE" "Industry FE" "N" "Adjusted R-sq")) ///
...
eststo regression1: reghdfe dacck visib_PM2_5 gparachute c.visib_PM2_5#c.gparachute $control_variables_aem_t78, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear) //c.?
estadd scalar ar2 = e(r2_a)
summarize dacck
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression2: reghdfe dacck visib_PM2_5 ppill c.visib_PM2_5#c.ppill $control_variables_aem_t78, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear) //c.?
estadd scalar ar2 = e(r2_a)
summarize dacck
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression3: reghdfe dac visib_PM2_5 gparachute c.visib_PM2_5#c.gparachute $control_variables_aem_t78, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear) //c.?
estadd scalar ar2 = e(r2_a)
summarize dac
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression4: reghdfe dac visib_PM2_5 ppill c.visib_PM2_5#c.ppill $control_variables_aem_t78, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear) //c.?
estadd scalar ar2 = e(r2_a)
summarize dac
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression5: reghdfe rem visib_PM2_5 gparachute c.visib_PM2_5#c.gparachute $control_variables_rem_t78, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize rem
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression6: reghdfe rem visib_PM2_5 ppill c.visib_PM2_5#c.ppill $control_variables_rem_t78, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize rem
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
mgroups("Accrual Earnings Management" "Real Earnings Management", pattern(1 0 0 0 1 0) prefix(\multicolumn{@span}{c}{) suffix(}) span erepeat(\cmidrule(lr){@span})) drop($control_variables_rem_t78 $control_variables_aem_t78) mtitles("\makecell{AEM \\ (performance-adj.)}" "\makecell{AEM \\ (performance-adj.)}" "\makecell{AEM \\ (modified Jones)}" "\makecell{AEM \\ (modified Jones)}" "REM" "REM")  collabels(none) booktabs label stats(firmcont yearfe indfe N ar2, fmt(0 0 0 0 2 2) labels("Baseline Controls" "Year FE" "Industry FE" "N" "Adjusted R-sq")) order(visib_PM2_5 gparachute c.visib_PM2_5#c.gparachute ppill c.visib_PM2_5#c.ppill) prehead("\begin{table}\begin{center}\scalebox{0.6}{\begin{tabular}{lcccccc}\toprule") posthead("\midrule&\multicolumn{6}{c}{\textbf{Panel C: CG = Golden Parachute or Poison Pill}}\\") /*starlevels(* 0.2 ** 0.1 *** 0.02)*/
...
label var dual_max "CEO-Chairman Duality"
	eststo clear
eststo regression1: reghdfe dacck  visib_PM2_5 CEOduality c.visib_PM2_5#c.CEOduality $control_variables_aem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear) //c.?
estadd scalar ar2 = e(r2_a)
summarize dacck
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression2: reghdfe dacck visib_PM2_5 dual_max c.visib_PM2_5#c.dual_max $control_variables_aem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear) //c.?
estadd scalar ar2 = e(r2_a)
summarize dacck
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression3: reghdfe dac visib_PM2_5 CEOduality c.visib_PM2_5#c.CEOduality $control_variables_aem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear) //c.?
estadd scalar ar2 = e(r2_a)
summarize dac
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression4: reghdfe dac visib_PM2_5 dual_max c.visib_PM2_5#c.dual_max $control_variables_aem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear) //c.?
estadd scalar ar2 = e(r2_a)
summarize dac
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression5: reghdfe rem visib_PM2_5 CEOduality c.visib_PM2_5#c.CEOduality $control_variables_rem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize rem
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression6: reghdfe rem visib_PM2_5 dual_max c.visib_PM2_5#c.dual_max $control_variables_rem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize rem
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
drop($control_variables_rem $control_variables_aem) ///
mtitles("Duality 1" "Duality 2" "Duality 1" "Duality 2" "Duality 1" "Duality 2") nonumbers collabels(none) booktabs label order(visib_PM2_5 CEOduality c.visib_PM2_5#c.CEOduality dual_max c.visib_PM2_5#c.dual_max) ///
...
esttab regression1 regression2 regression3 regression4 regression5 using "$output\table9_panelAB.tex", replace fragment keep(visib_PM2_5) ///
mgroups("Accrual Earnings Management" "Real Earnings Management", pattern(1 0 0 1 0) prefix(\multicolumn{@span}{c}{) suffix(}) span erepeat(\cmidrule(lr){@span})) ///
...
esttab regression1 regression2 regression3 regression4 regression5 using "$output\table9_panelAB.tex", append fragment keep(visib_PM2_5) ///
...
esttab regression1 regression2 regression3 regression4 regression5 using "$output\table9_panelCD.tex", replace fragment keep(visib_PM2_5) /// 
mgroups("Accrual Earnings Management" "Real Earnings Management", pattern(1 0 0 1 0) prefix(\multicolumn{@span}{c}{) suffix(}) span erepeat(\cmidrule(lr){@span})) ///
mtitles("\makecell{AEM \\ (performance-adj.)}" "\makecell{AEM \\ (modified Jones)}" "\makecell{AEM \\ Rank}" "REM" "\makecell{REM \\ Rank}") collabels(none) booktabs label ///
stats(firmcon yearfe indfe N ar2, fmt(0 0 0 0 2 2) labels("Baseline Controls" "Year FE" "Industry FE" "N" "Adjusted R-sq")) ///
...
esttab regression1 regression2 regression3 regression4 regression5 using "$output\table9_panelCD.tex", append fragment keep(visib_PM2_5) ///
nomtitles nonumbers collabels(none) booktabs label ///
...
label var fog "Fog"
	eststo clear
eststo regression1: reghdfe log_tfp visib_PM2_5 $control_variables, absorb(fyear) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize dacck
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression2: reghdfe log_tfp visib_PM2_5 $control_variables, absorb(ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize dacck
estadd scalar ymean = r(mean)
...
eststo regression3: reghdfe log_tfp visib_PM2_5 $control_variables, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize dacck
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
label var coastal "Coastal"
	...
	eststo clear
eststo regression1: reghdfe rem visib_PM2_5 $control_variables_rem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize rem
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression2: reghdfe rem visib_PM2_5 $control_variables_rem coastal, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize rem
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression3: reghdfe rem visib_PM2_5 $control_variables_rem coastal c.visib_PM2_5#c.coastal, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize rem
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression4: reghdfe rank_rem visib_PM2_5 $control_variables_rem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize rem
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression5: reghdfe rank_rem visib_PM2_5 $control_variables_rem coastal, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize rem
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
eststo regression6: reghdfe rank_rem visib_PM2_5 $control_variables_rem coastal c.visib_PM2_5#c.coastal, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize rem
estadd scalar ymean = r(mean)
estadd local yearfe "Yes", replace
...
label var visib_PM2_5 "Fitted visibility"
	...
	capture drop visib_PM2_5_median
	capture drop visib_PM2_5_binary
	capture drop visib_PM2_5_binary_neg
egen visib_PM2_5_median = median(visib_PM2_5)
gen visib_PM2_5_binary = (visib_PM2_5 < visib_PM2_5_median) if !mi(visib_PM2_5)
gen visib_PM2_5_binary_neg = -visib_PM2_5_binary
...
psmatch2 visib_PM2_5_binary $control_variables_psm, outcome(rem) ai(3) ///
...
eststo treatall: estpost sum $control_variables_psm if visib_PM2_5 < visib_PM2_5_median
eststo controlall: estpost sum $control_variables_psm if visib_PM2_5 >= visib_PM2_5_median
eststo diffall: estpost ttest $control_variables_psm, by(visib_PM2_5_binary_neg) 
eststo treatpsm: estpost sum $control_variables_psm if visib_PM2_5 < visib_PM2_5_median & _support == 1
eststo controlpsm: estpost sum $control_variables_psm if visib_PM2_5 >= visib_PM2_5_median  & _support == 1
eststo diffpsm: estpost ttest $control_variables_psm if _support == 1, by(visib_PM2_5_binary_neg) 

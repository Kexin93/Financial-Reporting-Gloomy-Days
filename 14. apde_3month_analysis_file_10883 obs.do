...
* 1) Table OA5: Firm characteristics using actual period end date and one-year exposure
eststo summ_stats: estpost sum $summ_vars
...
* 2) Table OA6: Weather characteristics using actual period end date and one-year exposure
label var temp "Temp."
label var dewp "Dew" 
label var slp  "Sea-level Pressure"
label var visib "Visibility"
...
* 3) Table OA7: The Effect of Visibility on Earnings Management (actual period end date and one-year exposure)
	eststo clear
eststo regression1: reghdfe dacck visib $control_variables_aem, absorb(fyear ff_48) vce(cluster i.lpermno#i.fyear)
estadd scalar ar2 = e(r2_a)
summarize dacck
